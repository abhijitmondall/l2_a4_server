...
export type UserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "email" | "password" | "role" | "status" | "photo" | "phone" | "address" | "gender" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>;
